# Validacion rapida: Tristeza

1. Iniciar la aplicacion local.
2. Abrir la Isla Tristeza desde el mapa emocional.
...
6. Confirmar que los siete recursos de `public/images/stories/tristeza/` responden desde el servidor local.
